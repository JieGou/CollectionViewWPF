 ...
 */
// from https://github.com/mik14a/ObservableCollectionExtensions/tree/master/ObservableCollectionExtensions
...
namespace ViewJumperWPF.Extensions
{
    /// <summary>
    ...
    public static class ObservableCollectionExtensions
    {
        ...
        private static class ObservableCollectionInvoker<T>
        {
            ...
            private static Action<ObservableCollection<T>> CreateCheckReentrancy()
            {
            ...
            private static Func<ObservableCollection<T>, IList<T>> CreateGetItems()
            {
                const BindingFlags bindingFlags = BindingFlags.NonPublic | BindingFlags.Instance;
                var type = typeof(ObservableCollection<T>);
            ...
            private static Action<ObservableCollection<T>, string> CreateOnPropertyChanged()
            {
                const BindingFlags bindingFlags = BindingFlags.NonPublic | BindingFlags.Instance;
                var type = typeof(ObservableCollection<T>);
            ...
            private static Action<ObservableCollection<T>, NotifyCollectionChangedEventArgs> CreateOnCollectionChanged()
            {
                const BindingFlags bindingFlags = BindingFlags.NonPublic | BindingFlags.Instance;
                var type = typeof(ObservableCollection<T>);
            ...
            private static Action<ObservableCollection<T>> checkReentrancy;
            private static Func<ObservableCollection<T>, IList<T>> getItems;
            private static Action<ObservableCollection<T>, string> onPropertyChanged;
            private static Action<ObservableCollection<T>, NotifyCollectionChangedEventArgs> onCollectionChanged;
        }
    }
}