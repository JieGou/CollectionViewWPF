...
namespace ViewJumperWPF.Controls
{
    ...
    public class FilterControl : Control
    {
        ...
        //按拼音搜索
        private readonly PinYinSearch pinYinSearch_0;
        ...
        public FilterControl()
        {
            ...
            this.pinYinSearch_0 = new PinYinSearch(PinYinSearchType.PinYin);
        }
        ...
        #endregion TargetControl property
        ...
        #endregion FilterTextBindingPath property
        ...
        #endregion FilterOnEnter property
        ...
        public static readonly DependencyProperty FilterFiringIntervalProperty =
            DependencyProperty.Register("FilterFiringInterval", typeof(int), typeof(FilterControl), new UIPropertyMetadata(100, new PropertyChangedCallback(OnFilterFiringIntervalChanged)));
        ...
        #endregion FilterFiringInterval property
        ...
        #endregion Overridden Functions/Methods
        ...
        private void ApplyFilterOnTarget()
        {
            ...
            collectionView.Filter = (m =>
            {
                ...
                List<string> list = new List<string>() { dataValue };
                this.pinYinSearch_0.SetKeywords(list);

                List<string> source = this.pinYinSearch_0.SearchTexts(this.FilterText, false);

                //return dataValue .IndexOf(this.FilterText, StringComparison.InvariantCultureIgnoreCase) > -1;
                return source.Contains(dataValue, StringComparer.OrdinalIgnoreCase)
                       || dataValue.Contains(this.FilterText);
            });
        }
